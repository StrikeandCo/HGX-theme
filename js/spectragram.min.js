...
if (typeof Object.create !== "function") {
    ...
    display: function (results) {
      ...
      if (results.data === undefined || results.meta.code !== 200 || results.data.length === 0) {
        ...
        for (var i = 0; i < max; i++) {
          ...
          $image = $("<div class=\"img\" style=\"background-image:url(" + size + ");\"></div>", {
            alt: imageCaption,
            /*attr: {
              height: imageHeight,
              width: imageWidth
  ...
  jQuery.fn.spectragram.accessData = {
    accessToken: '244793553.54da896.140985efb1ed4b13b0490a4dd212a098',
    clientID: 'd48808362bc146cc927bbf6fb12c7785'
  }
